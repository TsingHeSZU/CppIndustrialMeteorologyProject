...
/CppIndustrialMeteorologyProject/tools/bin/procctl 3600*24 /CppIndustrialMeteorologyProject/idc/bin/obtcode_to_db /CppIndustrialMeteorologyProject/idc/ini/stcode.ini "idc/idcpwd" "Simplified Chinese_China.AL32UTF8" /log/idc/obtcode_to_db.log
...
# 每 1 小时把 T_ZHOBTCODE 表中的全部数据抽取出来
...
/CppIndustrialMeteorologyProject/tools/bin/procctl 300 /CppIndustrialMeteorologyProject/tools/bin/deletefiles /idcdata/xmltodb/vipbak "*" 0.02
/CppIndustrialMeteorologyProject/tools/bin/procctl 300 /CppIndustrialMeteorologyProject/tools/bin/deletefiles /idcdata/xmltodb/viperr "*" 0.02
